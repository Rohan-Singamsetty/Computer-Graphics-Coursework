...
public class Lab3 extends GraphicsLab
{
    ...
    protected void initScene()
    {
        ...
        {   drawUnitCube(Colour.RED,Colour.RED,Colour.RED,Colour.RED,Colour.GREEN,Colour.GREEN,Colour.YELLOW,Colour.YELLOW);
        }
        GL11.glEndList();
    }
     ...
     */
    private void drawUnitCube(Colour near, Colour far, Colour left, Colour right, Colour top, Colour bottom,Colour frontTriangle,Colour backTriangle)
    {
        ...
        Vertex v9 = new Vertex(0.3f,  1.0f,  0.1f);
        Vertex v10 = new Vertex( -0.3f,  1.0f,  0.1f);
